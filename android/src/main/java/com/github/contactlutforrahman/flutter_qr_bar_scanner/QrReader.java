...
class QrReader {
    ...
    QrReader(int width, int height, DetectType detectType, Activity context, int barcodeFormats,
             final QRReaderStartedCallback startedCallback, final QrReaderCallbacks communicator, final CardReaderCallbacks cardCommunicator,
        ...
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            ...
            switch (detectType.getValue()) {
                ...
                case 2:
                case 3:
                    qrCamera = new QrCameraC2(width, height, context, texture, new CardDetector(context, cardCommunicator, detectType));
                    break;
                default:
                    qrCamera = new QrCameraC2(width, height, context, texture);
                    break;
            }
        } else {
